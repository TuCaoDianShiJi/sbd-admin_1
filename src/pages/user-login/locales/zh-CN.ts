export default {
  'user-login.login.userName': '请输入用户名/手机号',
  ...
  'user-login.register.get-verification-code': '获取短信验证码',
  ...
  'user-login.userName.required': '请输入用户名/手机号!',
  ...
  'user-login.verification-code.required': '请输入短信验证码！',
  ...
  'user-login.form.get-captcha': '发送验证码',
